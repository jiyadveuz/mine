                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="inbox-leftbar">
                            <div class="card-box">
                                <a href="compose.php" class="compose_btn"> <i class="fa fa-plus"></i> Compose</a>

                                <div class="mail-list mt-4">
                                    <a href="#" class="list-group-item border-0 text-info"><i
                                            ...
                                            <ul class="message-list">
                                                <li class="unread">
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Lucas Kriebel (via
                                                            Twitter)</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Lucas Kriebel
                                                            (@LucasKriebel) has
                                                            sent
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Randy, me (5)</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Last pic over my
                                                            village &nbsp;&ndash;&nbsp;
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Andrew Zimmer</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Mochila Beta:
                                                ...
                                                <li class="unread">
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Infinity HR</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Sveriges Hetaste
                                                            sommarjobb &nbsp;&ndash;&nbsp;
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Web Support
                                                            Dennis</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Re: New mail settings
                                                            &nbsp;&ndash;&nbsp;
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">me, Peter (2)</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Off on Thursday
                                                            &nbsp;&ndash;&nbsp;
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Medium</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">This Week's Top
                                                            Stories &nbsp;&ndash;&nbsp;
                                                ...
                                                <li>
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="read-message.php" class="title">Death to Stock</a><span
                                                                class="star-toggle fa fa-star-o"></span>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="read-message.php" class="subject">Montly High-Res
                                                            Photos &nbsp;&ndash;&nbsp;
                                                ...
                                                <li class="unread">
                                                    ...
                                                    <div class="col-mail col-mail-2">
                                                        <a href="#" class="subject">Home again! &nbsp;&ndash;&nbsp;
                                                            <span
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <div class="btn-group float-right">
                                            <button type="button"
                                                    class="btn btn-custom waves-light waves-effect btn-sm"><i
                                                        class="fa fa-chevron-left"></i></button>
                                            <button type="button"
                                                    class="btn btn-custom waves-effect waves-light btn-sm"><i
