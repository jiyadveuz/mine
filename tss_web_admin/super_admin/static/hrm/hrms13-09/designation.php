                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-12">
                                    <div class="pull-right p-t-10">
                                        <a data-toggle="modal" class="btn btn-info newbtn_crete" data-target="#newsdesignation"> <i class="mdi mdi-plus-circle-outline"></i> New
                                        </a>
                                    </div>
                                </div>
...
<div id="newsdesignation" class="modal fade" role="dialog" data-backdrop="static">
                            ...
                            <div class="col-md-12 m-t-8">
                                <div class="form-group">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <label class="inputText">Designation</label>
                                    </div>
                                </div>
                            </div>
                        </div>
