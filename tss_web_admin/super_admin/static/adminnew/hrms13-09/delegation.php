                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-group bmd-form-group required_item">
                                            ...
                                            <label class="inputText openselect2">Delegator</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <label class="inputText openselect2">Delegatee</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group bmd-form-group">
                                                    <div class="radio radio-info float_left_radio">
                                                        <input type="radio" id="TypeTemorory" name="Type" checked="checked">
                                                        <label for="TypeTemorory">Temporary</label>
                                                    </div>
                                                    <div class="radio radio-info">
                                                        <input type="radio" id="TypePermanent" name="Type">
                                                        <label for="TypePermanent">Permanent </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row m-b-15 daterange">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="col-sm-12">
                                                <div class="form-group bmd-form-group">
                                                    <div class="radio radio-info float_left_radio">
                                                        <input type="radio" id="notiDelegatee_dlgtee" name="notification">
                                                        <label for="notiDelegatee_dlgtee">Delegator and Delegatee</label>
                                                    </div>
                                                    <div class="radio radio-info">
                                                        <input type="radio" id="notiDelegatee" name="notification">
                                                        <label for="notiDelegatee">Delegatee </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#TypePermanent").click(function() {
            $(".daterange").addClass("hide");
        });
        $("#TypeTemorory").click(function() {
